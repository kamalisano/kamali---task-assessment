  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileInfoContainer}>
        ...
        <Image source={{ uri: 'https://tse2.mm.bing.net/th?id=OIP._6kSqsTmX5o4yeSjGnw48AHaLH&pid=Api&P=0&h=180' }} style={styles.avatar} />
        </View>
        <View style={styles.userInfoWrapper}>
          <Text style={styles.name}>John Mathew</Text>
          <Text style={styles.contact}>+91 98765 43210</Text>
          <Text style={styles.email}>joedyson@gmail.com</Text>
        </View>
      </View>
      </View>
...
<br/>
        ...
        <Text style={styles.addButtonTextlog}>Logout</Text>
      </TouchableOpacity>
